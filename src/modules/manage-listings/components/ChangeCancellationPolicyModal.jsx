...
import { cancellationPolicyTime, cancellationPolicyCharge } from '@/common/utilities/enumerables'
import { useRouter } from 'next/router'
import { useForm } from 'react-hook-form'
import ButtonContent from '@/common/ButtonContent'
import axios from 'axios'

function ChangeCancellationPolicyModal({setModalContent, item}) {     // may be able to delete condition if form can pick up condition value
    ...
    <>
      ...
      <form id='cancellation-policy-form' className='flex flex-col' onSubmit={handleSubmit(onSubmit)}> 
        ...
        <div className='flex flex-row' >
          <ButtonGeneral 
            type='submit' 
            formId='cancellation-policy-form' 
          >
            Confirm
          </ButtonGeneral>
...
export default ChangeCancellationPolicyModal